    ...
    _init : function() {
      ...
      thisObj.tableWrapper = $instTable.innertable({
          ...
          menu_click_create : function(e) {
			  ...
			  if (items.length != 1) {
				notifySuccess($.i18n.prop('error_msg_select_one', $.i18n.map.credentials_user));
				return false;
			  } 
        ...
        this.addDialog = $add_dialog.eucadialog({
		    ...
		    'create' : {
						...
						click : function() {
							...
							var account = thisObj.tableWrapper.innertable('getSelectedRows', 2)[0];
            ...
            success:
              function(data, textStatus, jqXHR){
                if (data.state) {
                    ...
                    notifyError($.i18n.map.error_msg_modify + ":" + data.message);
                }
