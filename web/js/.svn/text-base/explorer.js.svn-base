...
(function($, eucalyptus) {
  eucalyptus.explorer = function(){ 
    $.widget("eucalyptus.explorer", {
      options : {
        menus : [ 
                 {key:'dashboard', text:menu_dashboard}, 
                 {key:'infrastructure', text:images_label},
                 {key:'configurecloud', text:instances_label},
                 {key:'cloudmanagement', text:storage_label}
//                {key:'dashboard', text:menu_dashboard}, 
...
//                {key:'netsec', text:netsec_label}
		    ...
		    submenus : { 
//		    	storage: [{key:'volume', text:volumes_label}, {key:'snapshot', text:snapshots_label}, /*{key:'bucket', text:buckets_label},*/ ],
...
//                  instance: [{key:'instance', text:instances_label}, {key:'scaling', text:scaling_label}]
      ...
      createResourceMenu : function (idx, menu) {
        ...
        if(menu.key in this.options.submenus){//添加子菜单
          $menu.append($submenu);
